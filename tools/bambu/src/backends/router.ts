...
//
// Preference order (global CLAUDE.md "robust and simple beat cheap and easy"): the MCP is the
// primary transport; the BambuStudio CLI owns headless slicing; AppleScript is the floor for
// GUI-only actions. Each command asks the router for a backend rather than hard-wiring one, so the
