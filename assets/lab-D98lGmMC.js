import{C as e,S as t,_ as n,b as r,c as i,d as a,f as o,h as ee,i as te,l as ne,m as re,n as s,p as c,r as ie,s as l,t as ae,u as oe,v as se,x as ce}from"./style-BFHcl7lz.js";import"./modulepreload-polyfill-EeOZK34R.js";import{i as le,n as ue,r as de}from"./worker-host-DV2pcHZL.js";var u=[{id:`rosette-dodeca`,title:`Rosette · Dodecahedron`,blurb:`10-petal rosettes on 12 pentagonal faces`,source:`# Rosette-Orb — dodecahedral 10-petal rosette sphere.
...
orb Maclado9Overlap
  ...
  weave crossing alternating amplitude $amplitude
  overlap $overlap
`,qiyasComposite:{cells:null,ribbons:.999}},{id:`maclado-9-lattice`,title:`Maclado Lattice · Open shell`,blurb:`18 wheels along the D-031 walk, two sites open — a hemmed mouth`,source:`# Maclado-9-Lattice — the fourth Family-3 orb: an OPEN pierced bowl.
# The same nine-fold maclado wheels of Maclado-9, but placed on only 18 of
# the 20 dodecahedron sites — the first 18 of the D-031 lattice walk from
# site 0. The two unvisited sites (13, 14) are adjacent, so their gaps open
# onto a single mouth; the coastline around that mouth is hemmed into a
# watertight bowl (an inner + outer surface joined along one rim).
#
# Distinct from the closed field only as a PARTIAL shell: a walk over all 20
# sites is byte-for-byte Maclado-9 (the wheel positions are fixed by the
# dodecahedron — the walk only chooses the subset). See 3d-models
# docs/maclado-lattice-orb-design.md.
# Render with: bikar render Maclado-9-Lattice.bkr --format stl -o out.stl

# Cross-section defaults track Maclado-9's (strut_width 3 degenerates at
# radius 60 — the kernel throws rather than emit slivers). The rim is the
# same thick-shell cross-section as the struts, hemmed along the coastline,
# so it introduces no new free number (design doc §7).
param radius = 60 range 40..110 step 5
param strut_width = 2 range 1.5..2.5 step 0.25 advanced
param strut_depth = 2.4 range 1.2..4 step 0.2 advanced
