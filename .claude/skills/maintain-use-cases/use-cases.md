...
as_of:
  3d-models: d69a84dba9842a1566d7b7eb686a416cca93431e
...
literal after the range, as in `` `3d-models:Makefile:L157 "orbs:"` `` — and
...
| UC4 | Download a print-ready, gate-checked STL | Gallery visitor, Print operator | `3d-models:Makefile:L157 "orbs:"` (orbs pipeline target) |
| UC5 | Configure an orb with knobs, gate readout, and share links in the Lab | Lab visitor | `3d-models:Makefile:L295 "lab-vendor:"` (lab vendoring target) · `bikar:packages/lab/src/main.ts:L1` (Lab app) |
...
| UC9 | Cut cookies with printed cutters | Baker | `3d-models:Makefile:L151 "cookie-cutters:"` (cookie-cutters target) |
...
| UC11 | Publish the gallery + Lab to gh-pages | Designer | `3d-models:Makefile:L415 "deploy: validate-site-graph"` (deploy target) |
