...
as_of:
  3d-models: 525e5ba2848cfe02b2911c0dd57b9a275db6a9a4
  bikar: 12c76b634bf5c1e2693e6ef26b9deb00f9071bb7
...
| UC5 | Configure an orb with knobs, gate readout, and share links in the Lab | Lab visitor | `3d-models:Makefile:L273 "lab-vendor:"` (lab vendoring target) · `bikar:packages/lab/src/main.ts:L1` (Lab app) |
...
| UC11 | Publish the gallery + Lab to gh-pages | Designer | `3d-models:Makefile:L393 "deploy: validate-site-graph"` (deploy target) |
