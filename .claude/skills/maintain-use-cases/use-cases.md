...
as_of:
  3d-models: cc543b9bb2fb130c103fb4de10eed12214da8c29
  bikar: 0f497dfc5cc01dcb019188de8ca55966cf04ed69
...
|----|----------|--------|---------------|
| UC1 | Author `.bkr` patterns, orbs, and pieces in the bikar DSL | Designer | `bikar:packages/core/src/dsl/evaluator.ts:L1151 "function evaluateOrbDecl("` (orb eval) · `bikar:packages/core/src/dsl/evaluator.ts:L1496 "function evaluatePieceDecl("` (piece eval) · `bikar:docs/language-reference.md:L476 "## Orb Declarations (3D)"` (orb grammar) · `bikar:docs/language-reference.md:L552 "## Piece Declarations (3D)"` (piece grammar) |
| UC2 | Render STL / SVG / symmetry views with the watertight mesh gate | Designer | `bikar:packages/cli/src/index.ts:L743 "case 'render': {"` (render command) |
