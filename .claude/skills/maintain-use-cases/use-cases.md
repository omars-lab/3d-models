...
as_of:
  3d-models: aaf4da6b04f4b2c8c94102a7cf9aa0c1649638a8
  bikar: 2d60b0016751b456c743997c82e986b7c89e53eb
...
|----|----------|--------|---------------|
| UC1 | Author `.bkr` patterns, orbs, and pieces in the bikar DSL | Designer | `bikar:packages/core/src/dsl/evaluator.ts:L1141 "function evaluateOrbDecl("` (orb eval) · `bikar:packages/core/src/dsl/evaluator.ts:L1486 "function evaluatePieceDecl("` (piece eval) · `bikar:docs/language-reference.md:L476 "## Orb Declarations (3D)"` (orb grammar) · `bikar:docs/language-reference.md:L552 "## Piece Declarations (3D)"` (piece grammar) |
| UC2 | Render STL / SVG / symmetry views with the watertight mesh gate | Designer | `bikar:packages/cli/src/index.ts:L742 "case 'render': {"` (render command) |
