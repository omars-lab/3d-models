...
as_of:
  3d-models: 4c741698c57c6ea4ddca5d4a9e7b03ef2ecbe095
  bikar: fc5adee92b070cba4b69766a4c593cb6cb6a082a
...
literal after the range, as in `` `3d-models:Makefile:L167 "orbs:"` `` — and
...
|----|----------|--------|---------------|
| UC1 | Author `.bkr` patterns, orbs, and pieces in the bikar DSL | Designer | `bikar:packages/core/src/dsl/evaluator.ts:L1120 "function evaluateOrbDecl("` (orb eval) · `bikar:packages/core/src/dsl/evaluator.ts:L1465 "function evaluatePieceDecl("` (piece eval) · `bikar:docs/language-reference.md:L476 "## Orb Declarations (3D)"` (orb grammar) · `bikar:docs/language-reference.md:L552 "## Piece Declarations (3D)"` (piece grammar) |
| UC2 | Render STL / SVG / symmetry views with the watertight mesh gate | Designer | `bikar:packages/cli/src/index.ts:L735 "case 'render': {"` (render command) |
...
| UC4 | Download a print-ready, gate-checked STL | Gallery visitor, Print operator | `3d-models:Makefile:L167 "orbs:"` (orbs pipeline target) |
| UC5 | Configure an orb with knobs, gate readout, and share links in the Lab | Lab visitor | `3d-models:Makefile:L305 "lab-vendor:"` (lab vendoring target) · `bikar:packages/lab/src/main.ts:L1` (Lab app) |
...
| UC9 | Cut cookies with printed cutters | Baker | `3d-models:Makefile:L161 "cookie-cutters:"` (cookie-cutters target) |
