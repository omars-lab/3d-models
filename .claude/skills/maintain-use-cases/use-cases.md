...
as_of:
  3d-models: 476a946d6267f33d875aa0a8131936a9aec81e69
  bikar: d9b3c841397d1d6099107cfe86d1408a6fcddb31
...
literal after the range, as in `` `3d-models:Makefile:L164 "orbs:"` `` — and
...
|----|----------|--------|---------------|
| UC1 | Author `.bkr` patterns, orbs, and pieces in the bikar DSL | Designer | `bikar:packages/core/src/dsl/evaluator.ts:L1037 "function evaluateOrbDecl("` (orb eval) · `bikar:packages/core/src/dsl/evaluator.ts:L1382 "function evaluatePieceDecl("` (piece eval) · `bikar:docs/language-reference.md:L471 "## Orb Declarations (3D)"` (orb grammar) · `bikar:docs/language-reference.md:L547 "## Piece Declarations (3D)"` (piece grammar) |
...
| UC4 | Download a print-ready, gate-checked STL | Gallery visitor, Print operator | `3d-models:Makefile:L164 "orbs:"` (orbs pipeline target) |
| UC5 | Configure an orb with knobs, gate readout, and share links in the Lab | Lab visitor | `3d-models:Makefile:L302 "lab-vendor:"` (lab vendoring target) · `bikar:packages/lab/src/main.ts:L1` (Lab app) |
...
| UC9 | Cut cookies with printed cutters | Baker | `3d-models:Makefile:L158 "cookie-cutters:"` (cookie-cutters target) |
