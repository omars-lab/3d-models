...
| Family 2 — pierced lattice (`B5`) | `bikar:packages/core/src/kernel3d/solidify-lattice.ts:L216 "export function solidifyLattice("` |
| Family 1 — over/under solve and ribbons (`B6`) | `bikar:packages/core/src/kernel3d/weave.ts:L571 "export function weaveLattice("` |
...
| per-axis orthographic SVG (`E2`) | `bikar:packages/core/src/render/orb-view-renderer.ts:L306 "export function renderOrbViewSVG("` |
| symmetry axes and front-cap projection | `bikar:packages/core/src/kernel3d/orb-views.ts:L41 "export function symmetryViewAxes("` |
...
| the CLI that fans these out | `bikar:packages/cli/src/index.ts:L2526 "case 'render': {"` |
