...
**21 <!--count:cal-bets--> registered bets · 21 <!--count:cal-records-->
`Calibrated` records — 21 provisional, 0 measured · 6
...
and `qiyas`. 21 <!--count:cal-bets--> ids are registered in `CAL_BETS` <!--count:partial--> (twelve at the original
...
| | Count | Note |
|---|---|---|
| Registered `CAL-*` bets | 21 <!--count:cal-bets--> | 20 with a coupon, 6 <!--count:cal-bets-no-record--> without a record in bikar (`CAL-OVH-01`, `CAL-STR-01`, the two mural bets `CAL-REG-01`/`CAL-CLB-01`, and the two brick-anchor bets `CAL-ANC-01`/`CAL-INW-01`) |
...
21 <!--count:cal-bets--> registered bets and 15 <!--count:cal-mc-records--> of the
...
against the 10 <!--count:cal-bets-mc--> of 21 <!--count:cal-bets--> and 15
...
- **Counts reconcile — and are copied from the thing that prints them, not
  re-derived here.** 21 <!--count:cal-bets--> bets = 10 <!--count:cal-bets-mc--> on the card + 10 <!--count:cal-bets-design--> on design coupons
  ...
  `CAL-FRM-01` W-P1, `CAL-GRP-01` LG-D1) + 1 <!--count:cal-bets-no-coupon--> with no coupon (`CAL-STR-01`). The card's 10 are the
