...
**31 <!--count:cal-bets--> registered bets · 27 <!--count:cal-records-->
...
and `qiyas`. 31 <!--count:cal-bets--> ids are registered in `CAL_BETS` <!--count:partial--> (twelve at the original
...
31 <!--count:cal-bets--> registered bets and 15 <!--count:cal-mc-records--> of the
...
against the 10 <!--count:cal-bets-mc--> of 31 <!--count:cal-bets--> and 15
...
- **Counts reconcile — and are copied from the thing that prints them, not
  re-derived here.** 31 <!--count:cal-bets--> bets = 10 <!--count:cal-bets-mc--> on the card + 17 <!--count:cal-bets-design--> on design coupons
  ...
  `CAL-FRM-01` W-P1, `CAL-GRP-01` LG-D1, `CAL-CST-01` + `CAL-CST-02` + `CAL-CST-03` + `CAL-CST-04` + `CAL-CST-05` + `CAL-CST-06` CS-1, `CAL-CST-07` CS-4) + 4 <!--count:cal-bets-no-coupon--> with no coupon (`CAL-STR-01`, `CAL-EQV-01`, `CAL-EQV-02`, `CAL-PIN-01`). The card's 10 are the
