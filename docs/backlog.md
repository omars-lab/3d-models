...
| Entries in the prototype catalog | 39 <!--count:catalog-entries--> | 28 coupons (P1–P8, MC-1…MC-8, W-F1, W-C1, W-P1, LG-F1/F2/S1/R1/D1/B1/B2/P1/P2) + the 6 deliverables C1, C2, W1, W2 (catalogued 2026-08-03, §3.5) and the coasters CS-1…CS-6 and CS-8 (P3.3, D-069, D-070, D-071; CS-8 the eight-fold rDuxHF3xMOc, CS-7 lands with the lEfWSogWscs PR). Count is the one `make validate-catalog` prints, not a hand tally |
...
**Count: 39 <!--count:catalog-entries--> catalog entries = 39
...
- **Counts reconcile — and are copied from the thing that prints them, not
  ...
  record count does not track the bet count. 39 <!--count:catalog-entries--> print-gated items = 39 <!--count:catalog-entries--> catalog
