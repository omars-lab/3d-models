...
**30 <!--count:cal-bets--> registered bets · 27 <!--count:cal-records-->
`Calibrated` records — 27 provisional, 0 measured · 9
...
and `qiyas`. 30 <!--count:cal-bets--> ids are registered in `CAL_BETS` <!--count:partial--> (twelve at the original
...
| | Count | Note |
|---|---|---|
| Registered `CAL-*` bets | 30 <!--count:cal-bets--> | 27 with a coupon, 9 <!--count:cal-bets-no-record--> without a record in bikar (`CAL-OVH-01`, `CAL-STR-01`, the two mural bets `CAL-REG-01`/`CAL-CLB-01`, the two brick-anchor bets `CAL-ANC-01`/`CAL-INW-01`, the equivalence bets `CAL-EQV-01`/`CAL-EQV-02`, and the interlock tab-neck bet `CAL-CST-06`) |
| `Calibrated<T>` records | 27 <!--count:cal-records--> | all provisional, all listed in bikar's `.calibration-baseline.json` |
...
30 <!--count:cal-bets--> registered bets and 15 <!--count:cal-mc-records--> of the
27 <!--count:cal-records--> provisional records are settled by an MC-series coupon —
...
against the 10 <!--count:cal-bets-mc--> of 30 <!--count:cal-bets--> and 15
<!--count:cal-mc-records--> of 27 <!--count:cal-records--> that `bets.md` prints
...
- **Counts reconcile — and are copied from the thing that prints them, not
  re-derived here.** 30 <!--count:cal-bets--> bets = 10 <!--count:cal-bets-mc--> on the card + 17 <!--count:cal-bets-design--> on design coupons
  ...
  `CAL-FRM-01` W-P1, `CAL-GRP-01` LG-D1, `CAL-CST-01` + `CAL-CST-02` + `CAL-CST-03` + `CAL-CST-04` + `CAL-CST-05` + `CAL-CST-06` CS-1, `CAL-CST-07` CS-4) + 3 <!--count:cal-bets-no-coupon--> with no coupon (`CAL-STR-01`, `CAL-EQV-01`, `CAL-EQV-02`). The card's 10 are the
