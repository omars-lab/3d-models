...
**20 <!--count:cal-bets--> registered bets · 20 <!--count:cal-records-->
`Calibrated` records — 20 provisional, 0 measured · 6
...
and `qiyas`. 20 <!--count:cal-bets--> ids are registered in `CAL_BETS` <!--count:partial--> (twelve at the original
...
| | Count | Note |
|---|---|---|
| Registered `CAL-*` bets | 20 <!--count:cal-bets--> | 19 with a coupon, 6 <!--count:cal-bets-no-record--> without a record in bikar (`CAL-OVH-01`, `CAL-STR-01`, the two mural bets `CAL-REG-01`/`CAL-CLB-01`, and the two brick-anchor bets `CAL-ANC-01`/`CAL-INW-01`) |
| `Calibrated<T>` records | 20 <!--count:cal-records--> | all provisional, all listed in bikar's `.calibration-baseline.json` |
| Bets settled by the machine card (MC-1…MC-8) | 10 <!--count:cal-bets-mc--> | 15 <!--count:cal-mc-records--> of the 20 <!--count:cal-records--> records |
...
20 <!--count:cal-bets--> registered bets and 15 <!--count:cal-mc-records--> of the
20 <!--count:cal-records--> provisional records are settled by an MC-series coupon —
...
- **Counts reconcile — and are copied from the thing that prints them, not
  re-derived here.** 20 <!--count:cal-bets--> bets = 10 <!--count:cal-bets-mc--> on the card + 9 <!--count:cal-bets-design--> on design coupons
  ...
  `CAL-FRM-01` W-P1) + 1 <!--count:cal-bets-no-coupon--> with no coupon (`CAL-STR-01`). The card's 10 are the
  ...
  20 <!--count:cal-records--> records = 15 <!--count:cal-mc-records--> on the
