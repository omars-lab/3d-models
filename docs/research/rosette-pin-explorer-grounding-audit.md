...
- `.claude/skills/calibrate/bets.md`: "32<!--count:cal-bets--> registered bets · 28<!--count:cal-records--> `Calibrated` records — **27 provisional, 0 measured**"; CAL-STK-01 provisional (`STUD_ENTRY_MAX_MM_CAL` 0.15 at `lego.ts` L163–170), "LG-S1 settles it".
