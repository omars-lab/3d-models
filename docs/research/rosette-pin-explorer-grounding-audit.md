...
- `.claude/skills/calibrate/bets.md`: "23<!--count:cal-bets--> registered bets · 21<!--count:cal-records--> `Calibrated` records — **21 provisional, 0 measured**"; CAL-STK-01 provisional (`STUD_ENTRY_MAX_MM_CAL` 0.15 at `lego.ts` L163–170), "LG-S1 settles it".
